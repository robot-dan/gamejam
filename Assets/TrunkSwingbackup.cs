...
public class TrunkSwingbackup : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isGrappling())
        {
            ...
            Vector3 maxPoint = joint.connectedAnchor + maxDistance * (player.transform.TransformPoint(joint.anchor) - joint.connectedAnchor).normalized;
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetKey("e"))
        {
            if (joint != null)
            {
                ...
                if (limit.limit < maxDistance)
                {
                    limit.limit = limit.limit + 0.1f;
                    joint.linearLimit = limit;
                    if (fixedDistance)
                    {
                        SoftJointLimit limit2 = joint.linearLimit;
                        limit2.limit = maxDistance - limit.limit;
        ...
        else if (Input.GetKey("q"))
        {
            if (joint != null)
            {
                ...
                if (limit.limit > 0.1f)
                {
                    ...
                    {
                        SoftJointLimit limit2 = joint.linearLimit;
                        limit2.limit = maxDistance - limit.limit - 1.8f;
                        joint2.linearLimit = limit2;
                    }
